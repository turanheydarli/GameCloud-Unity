...
namespace GameCloud
{
    public class GameCloudSettings : ScriptableObject
    {
        ...
        [Header("Connection Settings")] public string GameKey = "";
        public string Host = "api.gamecloud.example.com";
        public int Port = 7350;
        public bool UseSSL = true;

        [Header("Authentication Settings")] public bool AllowGuestAuth = true;
        public bool AllowCustomAuth = true;
        public int SessionTokenExpiry = 3600;

        [Header("Matchmaking Settings")] public string DefaultQueueName = "default";
